...
void UBlasterAnimInstance::NativeUpdateAnimation(float DeltaSeconds)
{
	...
	bUseAimOffsets = BlasterCharacter->GetCombatState() != ECombatState::ECS_Unoccupied && !BlasterCharacter->GetDisableGemeplay();
	bTransformRightHand = BlasterCharacter->GetCombatState() != ECombatState::ECS_Unoccupied && !BlasterCharacter->GetDisableGemeplay();
}
